...
<body>
  <div class="wrapper">
    ...
    <div class="button-container">
      <a href="Movies/10. The Wind Rises/The Wind Rises.html"><button class="button">Play</button></a>
    ...
    <section class="main-container">
      <div class="location" id="home">
          ...
          <div class="box">
            <a href="Movies/10. The Wind Rises/The Wind Rises.html" class="my-link">
